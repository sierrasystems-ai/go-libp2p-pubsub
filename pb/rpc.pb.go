...
func (x *TopicScopedMessage) GetFrom() string {
	if x != nil && x.From != nil {
		return *x.From
	}
	return ""
...
type TopicRPC struct {
	state         protoimpl.MessageState    `protogen:"open.v1"`
	Publish       *TopicScopedMessage       `protobuf:"bytes,1,opt,name=publish" json:"publish,omitempty"`
	Partial       *PartialMessagesExtension `protobuf:"bytes,2,opt,name=partial" json:"partial,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_rpc_proto_rawDesc = "" +
	...
	"\tsignature\x18\x05 \x01(\fR\tsignature\x12\x10\n" +
	"\x03key\x18\x06 \x01(\fR\x03key\"\x82\x01\n" +
	"\bTopicRPC\x127\n" +
	"\apublish\x18\x01 \x01(\v2\x1d.pubsub.pb.TopicScopedMessageR\apublish\x12=\n" +
	"\apartial\x18\x02 \x01(\v2#.pubsub.pb.PartialMessagesExtensionR\apartialB1Z/github.com/libp2p/go-libp2p-pubsub/pb;pubsub_pb"
